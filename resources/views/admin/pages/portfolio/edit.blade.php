            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-7">
                                <form action="{{ route('portfolios.update', $portfolio->id) }}" method="post" id="mainForm"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="portfolio_category_id" class="form-control">
                                                    ...
                                                    @foreach($categories as $cat)
                                                        <option value="{{ $cat->id }}" {{ $portfolio->portfolio_category_id == $cat->id ? 'selected' : '' }}>
                                                            {{ $cat->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <p>Proje URL</p>
                                                <input type="text" name="project_url" value="{{ $portfolio->project_url }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <p>Sıra</p>
                                        <input type="number" name="order" value="{{ $portfolio->order ?? 0 }}"
                                            class="form-control">
                                    </div>
                                            ...
                                            <div class="col-lg-12 col-12">
                                                @if($portfolio->image)
                                                    ...
                                                    <img src="/storage/{{ $portfolio->image }}"
                                                        style="width:100%;max-height:180px;object-fit:cover;margin-bottom:15px">
                                                @endif
