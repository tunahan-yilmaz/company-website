            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form class="text-left" action="{{ route('admin.checklogin') }}" method="post">@csrf
                            @method('post')
                            <div class="form">
                        ...
                        <p class="terms-conditions">Copyright © {{ date('Y') }} <a style="color: blue"
                                href="https://dbssoftware.com" target="_blank">DBS Software</a>, Tüm Hakları Saklıdır.
                        </p>
                    </div>
                </div>
            </div>
