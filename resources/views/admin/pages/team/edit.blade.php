            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-7">
                                <form action="{{ route('team.update', $team->id) }}" method="post" id="mainForm"
                                        ...
                                        <div class="tab-pane fade show active" id="underline-1" role="tabpanel"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <p>Unvan / Görev</p>
                                                        <input type="text" name="role" value="{{ $team->role }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <p>Sıra</p>
                                                        <input type="number" name="order" value="{{ $team->order ?? 0 }}"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="linkedin_url"
                                                            value="{{ $team->linkedin_url }}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="twitter_url"
                                                            value="{{ $team->twitter_url }}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <p>GitHub URL</p>
                                                        <input type="text" name="github_url" value="{{ $team->github_url }}"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-12">
                                                @if($team->image)
                                                    ...
                                                    <img src="/storage/{{ $team->image }}"
                                                        style="width:100%;max-height:180px;object-fit:cover;margin-bottom:15px;border-radius:8px">
                                                @endif
