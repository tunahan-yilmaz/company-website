            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ route('timeline.update', $timeline->id) }}" method="post" id="mainForm"
                                    enctype="multipart/form-data">@csrf @method('put')
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <p>Yıl</p>
                                                <input type="text" name="year" value="{{ $timeline->year }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <p>Sıra</p>
                                                <input type="number" name="order" value="{{ $timeline->order ?? 0 }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
